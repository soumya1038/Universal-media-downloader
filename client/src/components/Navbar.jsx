    ...
    <>
      <nav className="fixed top-0 left-0 right-0 z-50 flex justify-center px-4 pt-5 pb-2 pointer-events-none">
        <motion.div
          ...
          className="glass-card !rounded-full !py-2 !px-4 shadow-xl flex items-center justify-between gap-4 pointer-events-auto w-full max-w-3xl"
        ...
        >
          ...
          <Link to="/" className="flex items-center gap-2 no-underline group shrink-0">
            ...
            <span className="font-display font-black text-lg tracking-tight hidden sm:inline-block" style={{ color: 'var(--color-text-primary)' }}>
            ...
            {navLinks.map((link) => {
              ...
              return (
                <Link
                  key={link.path}
                  to={link.path}
                  className="no-underline px-5 py-2.5 rounded-full text-[11px] font-black uppercase tracking-widest transition-all duration-300 flex items-center gap-2 relative"
          ...
          <div className="flex items-center gap-1 shrink-0">
            <button
              onClick={toggleTheme}
              className="w-10 h-10 rounded-full flex items-center justify-center border-none cursor-pointer transition-all hover:bg-white/10 active:scale-90 bg-transparent"
            ...
            {/* Mobile hamburger */}
            <button
              className="md:hidden w-10 h-10 rounded-full flex items-center justify-center border-none cursor-pointer hover:bg-white/10 active:scale-90 bg-transparent"
